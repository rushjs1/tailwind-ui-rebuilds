<template>
  ...
  >
    <div class="flex items-center space-x-2">
      ...
      <a href="#" class="truncate hover:text-blue-600 hover:underline"
        >Update changelog</a
      >
    </div>
    <div class="flex items-end">
      ...
      <a href="#" class="group ml-3 flex items-center space-x-1">
        ...
        <span class="hidden text-gray-600 group-hover:text-blue-500 sm:block"
          >4,620</span
        >
        <span class="hidden text-gray-400 group-hover:text-blue-500 sm:block">
          commits
        </span>
      </a>
    </div>
