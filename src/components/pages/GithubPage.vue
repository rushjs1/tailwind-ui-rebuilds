      ...
      <div class="file-explorer-container w-3/4 mr-8">
        <div class="branch-nav flex items-center justify-between mb-3">
          <div class="flex items-center space-x-3">
            <button
              class="border border-gray-300 rounded-md px-4 py-1 hover:bg-gray-200 flex items-center space-x-2"
            >
              <svg
                class="h-4"
                text="gray"
        ...
        <!-- Commits Container -->
        <div
          class="bg-blue-100/50 rounded-md rounded-b-none border border-blue-100 border-b-none flex items-center justify-between px-4 py-4 mt-5"
        >
          <div class="flex items-center space-x-2">
            <img
              class="w-5 h-5 rounded-full"
          ...
          <div class="flex items-end">
            ...
            <a href="#" class="flex items-center ml-3 space-x-1 group">
              ...
              <span class="text-gray-600 group-hover:text-blue-500">4,620</span>
        ...
        <!-- Commits container end -->
        <!-- file explorer -->
        <div
          class="file-explorer rounded-md rounded-t-none border border-gray-200 text-gray-700 divide-y divide-gray-200"
        >
          ...
          <div class="flex justify-between px-4 py-2">
            ...
            >
              ...
              <span class="text-blue-500 hover:underline">#8226</span>)
            </div>
