<template>
  <div class="text-gray-900 text-sm">
    ...
    <div class="repo-stats flex items-center justify-between px-8 py-4">
      <div class="flex">
        <svg aria-hidden="true" viewBox="0 0 16 16" data-view-component="true" class="w-4 fill-current">
          <path
            fill-rule="evenodd"
      ...
      <div class="space-x-2 flex">
        ...
        <div class="flex">
          <button class="border border-gray-400 rounded rounded-r-none px-3 py-1 flex items-center space-x-1">
            <svg class="w-4" aria-hidden="true" viewBox="0 0 16 16" data-view-component="true">
              <path
                fill-rule="evenodd"
    ...
    <ul class="repo-nav border-b border-gray-400 flex items-center px-8 mt-4">
      <li class="font-semibold">
        <a href="#" class="flex items-center border-b-2 border-red-500 px-4 pb-3">
          <svg class="w-4 h-4" aria-hidden="true" viewBox="0 0 16 16" data-view-component="true">
            <path
              fill-rule="evenodd"
      ...
      <li class="font-semibold">
        <a href="#" class="flex items-center border-b-2 border-transparent px-4 pb-3 hover:border-gray-200">
          <svg class="w-4 h-4" aria-hidden="true" viewBox="0 0 16 16" data-view-component="true">
          ...
          <span class="bg-gray-100 rounded-lg text-center px-2 ml-2"> 13 </span>
        </a>
      </li>
      <li class="font-semibold">
        <a href="#" class="flex items-center border-b-2 border-transparent px-4 pb-3 hover:border-gray-200">
          ...
          <span class="bg-gray-100 px-2 rounded-lg ml-2 text-center">20</span>
        </a>
      </li>
      <li class="font-semibold">
        <a href="#" class="flex items-center border-b-2 border-transparent px-4 pb-3 hover:border-gray-200">
    ...
    <div class="container mx-auto my-8 px-4 flex">
      <div class="file-explorer-container w-3/4 mr-8">
        <div class="branch-nav flex items-center justify-between mb-3">
          <div class="flex items-center space-x-3">
            <button class="border border-gray-300 rounded-md px-4 py-1 hover:bg-gray-200 flex items-center space-x-2">
              <svg class="h-4" text="gray" aria-hidden="true" viewBox="0 0 16 16" data-view-component="true">
                <path
                  fill-rule="evenodd"
            ...
            <a href="#" class="flex items-center space-x-1 py-1 group">
              <svg
                class="h-4 fill-current group-hover:text-blue-600"
                aria-hidden="true"
                viewBox="0 0 16 16"
                data-view-component="true"
              >
          ...
          <div class="flex items-center space-x-2">
            <button class="rounded-lg border border-gray-300 px-2 py-1 font-semibold hover:bg-gray-200">
              Go to file
            </button>
            <button
              class="font-semibold rounded-lg border border-gray-300 px-2 py-1 flex items-center space-x-1 hover:bg-gray-200"
            >
              <span>Add file</span>
              <svg
                class="w-3 h-3"
            ...
            <button
              class="border border-gray-400 rounded-lg bg-green-600 hover:bg-green-700 text-white px-4 py-1 flex items-center space-x-2 shadow shadow-md font-semibold"
            >
              <svg
                class="w-4 h-4"
                fill="none"
      ...
      <div class="sidebar w-1/4">
        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Qui harum aperiam expedita ipsum sint incidunt,
        commodi odit voluptatum nam numquam nihil velit voluptates doloribus veniam voluptate doloremque minima placeat
        eos?
      </div>
    </div>
  </div>
