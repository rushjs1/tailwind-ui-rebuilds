  ...
  <div class="text-gray-900 text-sm">
    ...
    <div class="container mx-auto my-8 px-4 flex">
      <div class="file-explorer-container w-3/4 mr-8">
        <div class="branch-nav">branch nav</div>
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Perferendis asperiores, facere rem sed a magni aperiam?
        Quaerat maiores odio doloribus, blanditiis recusandae provident architecto amet, ut praesentium voluptatem
        aperiam dolorem.
      </div>
